#pragma checksum "c:\Users\Zachariasz\Desktop\Zachariasz Jankowski\Views\Projects\Website.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3bfd75f7be1fe4b5d68e25ecc9f0300b0fa31ced"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3bfd75f7be1fe4b5d68e25ecc9f0300b0fa31ced", @"/Views/Projects/Website.cshtml")]
...
#nullable restore
#line 48 "c:\Users\Zachariasz\Desktop\Zachariasz Jankowski\Views\Projects\Website.cshtml"
                                                                                                                                                                                                                                                Write(timeSpan);
...
#nullable disable
            ...
            WriteLiteral(@"nging to implement was the dynamic post loading in the feed section. The client-side logic doesn't load any new posts from the server unless the user has scrolled near the page bottom. The posts can be liked, which created a need for authentication and a well-designed database. This is the first web project that I ever completed.
                    ...
                    <div id=""t2"" class=""par mb-2"">
                        <div class=""p-2"">
                            ...
                            <p class="" p-2 "">This project was generated and built with the <a target=""_blank"" href=""https://computersciencebypolishguy.blogspot.com/2020/01/mvc-design-pattern.html""> MVC design pattern</a> in mind. Hence, it has a very straightforward structure that I will briefly introduce in t");
            WriteLiteral("his section. </p>\r\n                            <a target=\"_blank\" href=\"\\Images\\projects\\Project_Structure.png\"><img src=\"\\Images\\projects\\Project_Structure.png\" width=\"100%\" class=\"d-inline-block mr-1 \"");
            ...
            WriteLiteral(@"             </ul>
                            ...
                            <ul>
                                <li><a target=""_blank"" href=""https://github.com/JankowskiZachariasz/Zacha");
            WriteLiteral(@"riasz-Jankowski/blob/master/Views/Shared/_Layout.cshtml"">_Layout.cshtml</a><i class=""codeComment""> <- Parts that are common for all the sections </i> </li>
                            ...
                            <ul>
                                <li><a target=""_blank"" href=""https://github.com/JankowskiZachariasz/Zachariasz-Jankowski/bl");
            WriteLiteral(@"ob/master/wwwroot/js/Filler.js"">Filler.js</a><i class=""codeComment""> <- pulls posts from the server </i></li>
                                ...
                                <li><a target=""_blank"" href=""https://github.com/JankowskiZachariasz/Zachariasz-Jankowski/blob/master/wwwroot/js/projects.js");
            WriteLiteral(@""">projects.js</a></li>
                    ...
                    <div id=""t3"" class=""par mb-2"">
                        <div class=""p-2"">
                            ...
                            <ul>
                                <li><a target=""_blank"" href=""https://github.c");
            WriteLiteral(@"om/JankowskiZachariasz/Zachariasz-Jankowski/blob/master/Controllers/FeedController.cs"">FeedController.cs</a><i class=""codeComment""> <- server-side logic (see the Json(int id) method) </i></li>
                            ...
                            <p class=""p-2"">
                                One of the issues I encountered was the asynchronous nature of the $getJSON() function, which would result in the nondeterministic order of posts (some of them would load and get appended to the docum");
            WriteLiteral(@"ent faster than others).
...
<pre><code class=""lang-js ml-3 mr-3"">
    ...
    if (items.length < data.ol + 5)
        for (var");
            BeginWriteAttribute("i", " i =", 11150, "", 11154, 0);
            EndWriteAttribute();
            WriteLiteral(@" 0; i < ((data.ol + 5) - items.length); i++) {
    ...
    $(doc).appendTo("".container"" + data.ol);
                    ...
                    <ul>
                        <li><a target=""_blank"" href=""https://github.com/JankowskiZachariasz/Zachariasz-Jankowski/blob/master/Data/DataDbContext.cs"">DataDbContext.cs</a><i class=""c");
            WriteLiteral(@"odeComment""> <- posts, likes, etc. </i></li>
                    ...
                    <ol>
                        ...
                        <a target=""_blank"" href=""\Images\projects\ED1.png""><img src=""\Images");
            WriteLiteral("\\projects\\ED1.png\" class=\"dontexceed d-inline-block mr-1 \"");
            BeginWriteAttribute("alt", " alt=\"", 13260, "\"", 13266, 0);
            EndWriteAttribute();
            WriteLiteral(@"></a>
                        ...
                        <a target=""_blank"" href=""\Images\projects\ED2.png""><img src=""\Images\projects\ED2.png"" class=""dontexceed d-inline-block mr-1 """);
            BeginWriteAttribute("alt", " alt=\"", 13589, "\"", 13595, 0);
            EndWriteAttribute();
            WriteLiteral(@"></a>
                        <li>I added these tables to my database by creating two new models, adding them to the DbContext, and finally crating a new migration.</li>
...
<pre><code class=""lang-cs ml-3 mr-3"">
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity < Like >().HasKey(c => new {c.username, c.post});
    }
    ...
    public DataDbContext(DbContextOptions < DataDbContext > options): base(options) {}
                ...
                <div class=""sect  p-1 pl-2 rounded d-flex d-inline-block"" onclick=""toggle('5')""><h4 class=""mb-0"">Last-Update Feature</h4> <h4 id=""i5"" class=""mb-0 ml-auto mr-2"">+</h4> </div>
                <div id=""t5"" class=""par mb-2"">
                    <d");
            WriteLiteral(@"iv class=""p-2"">
                        <p class=""p-2"">
                            Each project page shows when was the last time any changes were committed to the designated git repository. To get this information, the server hosting my webpage must download a specified GitHub page and extract the date of the last commit from there. However, doing it when a new client connects to the server and requests a webpage increases loading time dramatically. 
                        </p>
                        <p class=""p-2"">
                            I realized it's necessary to perform this action periodically and store the results in a database. To achieve this, I chose Hangfire library and added it to my project. This is a function that executes every hour to obtain information about my projects from GitHub:
                        </p>
<pre><code class=""lang-cs ml-3 mr-3"">
public async Task UpdateDates()
{
    ...
    for (int i = 0; i < projects");
            ...
            BeginWriteAttribute("first", " first =", 15698, "", 15706, 0);
            EndWriteAttribute();
            WriteLiteral(" 0;\r\n\r\n        using (WebClient");
            BeginWriteAttribute("client", " client =", 15737, "", 15746, 0);
            EndWriteAttribute();
            WriteLiteral(" new WebClient())");
            BeginWriteAttribute("{result", "\r\n        {result =", 15763, "", 15782, 0);
            EndWriteAttribute();
            WriteLiteral(@" client.DownloadString(projects[i].remoteAddress);}
...
<script src=""https://cdnjs.cloudflare.com/ajax/");
            WriteLiteral("libs/popper.js/1.14.3/umd/popper.min.js\" integrity=\"sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49\" crossorigin=\"anonymous\"></script>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3bfd75f7be1fe4b5d68e25ecc9f0300b0fa31ced23621", async() => {
            }
            );
