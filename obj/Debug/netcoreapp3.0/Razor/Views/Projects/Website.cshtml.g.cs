#pragma checksum "c:\Users\Zachariasz\Desktop\Zachariasz Jankowski\Views\Projects\Website.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f1911bc85fd945bc02d11f1f839ad168d3939324"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f1911bc85fd945bc02d11f1f839ad168d3939324", @"/Views/Projects/Website.cshtml")]
...
#nullable disable
            ...
            WriteLiteral(@" the feed section. The server-side logic doesn't load any new posts from the server unless the user has scrolled near the page bottom. The posts can be liked, which created a need for authentication and a well-designed database. This is the first web project that I ever completed.
                ...
                <div id=""t2"" class=""par mb-2"">
                    ...
                    <a target=""_blank"" href=""\Images\projects\Project_Structure.png""><img src=""\Images");
            WriteLiteral("\\projects\\Project_Structure.png\" width=\"100%\" class=\"d-inline-block mr-1 \"");
            ...
            WriteLiteral(@"></a>
                    ...
                    <p class=""pl-4 ");
            WriteLiteral(@"""><b>Models</b> - Based on their structure, the Entity Framework generates tables in MySQL databases. Furthermore, they come in handy while accessing or modifying the existing data.</p>
                    <ul>
                    ...
                    <ul>
                        <li><a target=""_blank"" href=""https://github.com/JankowskiZachariasz/Zachariasz-Jankowski/blob/master/Views/Shared/_Layout.cshtml"">_Layout.cshtml</a><i class=""codeCommen");
            WriteLiteral(@"t""> <- Parts that are common for all the sections </i> </li>
                ...
                ");
            WriteLiteral(@"        <li><a target=""_blank"" href=""https://github.com/JankowskiZachariasz/Zachariasz-Jankowski/blob/master/wwwroot/js/like.js"">like.js</a><i class=""codeComment""> <- processes like & dislike actions </i></li>
                ...
                <div class=""sect  p-1 pl-2 rounded d-flex d-");
            WriteLiteral(@"inline-block"" onclick=""toggle('3')""><h4 class=""mb-0"">Dynamic Post Loading</h4> <h4 id=""i3"" class=""mb-0 ml-auto mr-2"">+</h4> </div>
                ...
                <div class=""sect  p-1 pl-2 rounded d-flex d-inline-block"" onclick=""toggle('4')""><h4 class=""mb-0"">""Last Update"" feature</h4> <h4 id=""i4"" class=""mb-0 ml-auto mr-2"">+</h4> </div>
                <div id=""t4"" class=""par mb-2"">
                    <p class="" p-2 "">I was inspired to build this website after I realis");
            WriteLiteral(@"ed that there's no better way to showcase my coding skills than by creating my online presence.
                        I used ASP.NET and C# for the back-end and Bootstrap with some standard javascript libraries for the front-end. The most challenging part was to create the feed section. 
                        It combines all the contents that I post on various social media in one place.</p>
                </div>
                ...
                <div id=""t5"" class=""par mb-2"">
                    <p class="" p-2 "">I was inspired to build this website after I realised that there's no better way to showcase my coding skills than by creating my online presence.
                        I used ASP.NET and C# for the back-end and Bootstrap with some standard javascript libraries for the front-end. The most challenging part was to create th");
            WriteLiteral(@"e feed section. 
                        It combines all the contents that I post on various social media in one place.</p>
                </div>
                ...
                <div class=""sect  p-1 pl-2 rounded d-flex d-inline-block"" onclick=""toggle('7')""><h4 class=""mb-0"">Database</h4> <h4");
            WriteLiteral(@" id=""i7"" class=""mb-0 ml-auto mr-2"">+</h4> </div>
            ...
            <p class=""pt-1 par"" >I was inspired to build this website after I realised that there's no better way to showcase my coding skills than by creating my online presence. I used ASP.NET and C# for the back-end and Bootstrap");
            WriteLiteral(@" with some standard javascript libraries for the front-end. The most challenging part was to create the feed section. It combines all the contents that I post on various social media in one place.</p> -->
        ...
        <div class=""d-flex justify-content-center bg-white  col-lg-6 offset-lg-3 "">
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "f1911bc85fd945bc02d11f1f839ad168d393932419055", async() => {
            }
            );
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f1911bc85fd945bc02d11f1f839ad168d393932420605", async() => {
            }
            );
